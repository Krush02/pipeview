        ...
        <div className="flex items-center justify-end text-gray-500 p-3">
          <div className='flex items-center space-x-1 border-2 p-1 rounded-full'>
              ...
              <div className='dropdown inline-block relative group'>
                  ...
                  <ul class="dropdown-menu absolute hidden text-gray-700 pt-1 w-40 -left-4 group-hover:block">
                      <li class=""><a class="items-center gap-x-2 flex rounded-t bg-zinc-200 hover:bg-zinc-300 py-2 px-4" href="/">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 6a7.5 7.5 0 107.5 7.5h-7.5V6z" />
                      <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 10.5H21A7.5 7.5 0 0013.5 3v7.5z" />
                      </svg>
                      Dashboard</a></li>
                      <li class=""><a class="items-center gap-x-2 flex bg-zinc-200 hover:bg-zinc-300 py-2 px-4" href="/aes">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 3v11.25A2.25 2.25 0 006 16.5h2.25M3.75 3h-1.5m1.5 0h16.5m0 0h1.5m-1.5 0v11.25A2.25 2.25 0 0118 16.5h-2.25m-7.5 0h7.5m-7.5 0l-1 3m8.5-3l1 3m0 0l.5 1.5m-.5-1.5h-9.5m0 0l-.5 1.5m.75-9l3-3 2.148 2.148A12.061 12.061 0 0116.5 7.605" />
                      </svg>
                      AE's
                      </a></li>
                      <li class=""><a class="items-center gap-x-2 flex bg-zinc-200 hover:bg-zinc-300 py-2 px-4" href="/sdrs">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M12 3c2.755 0 5.455.232 8.083.678.533.09.917.556.917 1.096v1.044a2.25 2.25 0 01-.659 1.591l-5.432 5.432a2.25 2.25 0 00-.659 1.591v2.927a2.25 2.25 0 01-1.244 2.013L9.75 21v-6.568a2.25 2.25 0 00-.659-1.591L3.659 7.409A2.25 2.25 0 013 5.818V4.774c0-.54.384-1.006.917-1.096A48.32 48.32 0 0112 3z" />
                    </svg>
                      SDR's</a></li>
                      <li class=""><a class="items-center gap-x-2 bg-zinc-200 hover:bg-zinc-300 py-2 px-4 flex" href="/settings">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
                      ...
                      <li class=""><p class="items-center gap-x-2 flex rounded-b bg-zinc-200 hover:bg-zinc-300 hover:cursor-pointer py-2 px-4" onClick={logout}>
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
